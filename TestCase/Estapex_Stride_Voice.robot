...
Login_and_Pair_Device
    ...
    Sleep       10
Estapex_Stride_Voice_Dashboard_Page
    Estapex_Landing_Page
Estapex_Stride_Voice_Settings_Page
    Goto_Settings_Page
    Sleep      4
Estapex_Stride_Voice_Feature_Verification
...
Estapex_Stride_Voice_My_Watch_Page
   Estapex_Stride_Voice_My_Watch_Page
Estapex_Stride_Voice_Verify_Profile_Page
