...
Login_and_Pair_Device
    ...
    Sleep       10
TouchELX_Storm_Connect_Plus_Dashboard_Page
    TouchELX_Lunar_Call_Landing_Page
TouchELX_Storm_Connect_Plus_Settings_Page
    Goto_Settings_Page
TouchELX_Storm_Connect_Plus_Features_verification
...
#    Fitness_Plan_Page
TouchElX_Storm_Connect_Plus_Watch_Page
    TouchELX_Lunar_Call_My_Watch_Page_Feature
TouchELX_Storm_Connect_Plus_Profile_Page
    TouchELX_Lunar_Call_Profile_Page
TouchELX_Storm_Connect_Plus_Home_Page
