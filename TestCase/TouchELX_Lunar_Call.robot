...
Login_and_Pair_Device
    ...
    Sleep       10
TouchELX_Lunar_Call_Dashboard_Page
    TouchELX_Lunar_Call_Landing_Page
TouchELX_Lunar_Call_Settings_Page
    Goto_Settings_Page
TouchELX_Lunar_Call_Features_Verification
