...
Login_and_Pair_Device
    ...
    Sleep       10
Estapex_Primia_Ace_Dashboard_Page
    Estapex_Landing_Page
Estapex_Primia_Ace_Settings_Page
    Goto_Settings_Page
    Sleep      4
Estapex_Primia_Ace_Feature_Verification
...
Estapex_Primia_Ace_My_Watch_Page
   Estapex_Stride_Voice_My_Watch_Page
Estapex_Primia_Ace_Verify_Profile_Page
   TouchELX_Lunar_Call_Profile_Page
EstaPex_Primia_Ace_Home_Page
