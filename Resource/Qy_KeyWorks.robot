...
${OTP_Auto_Fill_Allow}              com.coveiot.android.boat.qa:id/positive_btn
${Auto_Fill_OTP_Popup_title}         com.coveiot.android.boat.qa:id/title
...
${feedback_popup_close}      com.coveiot.android.boat.qa:id/iconClose

#Landing page
${Hello_Text}              com.coveiot.android.boat.qa:id/tvHello
...
${boat.qa_Logo}             com.coveiot.android.boat.qa:id/imgVLogo
...
${Dashboard_Skip_Notification_Settings}             com.coveiot.android.boat.qa:id/negative_tv
${CZ_Dashboard_Disclaimer_OK}            com.coveiot.android.boat.qa:id/btDisclaimerOk
${Weekly_Report_Popup}      com.coveiot.android.boat.qa:id/tvWeekly
${Weekly_Report_Email_Enter}      com.coveiot.android.boat.qa:id/email_edt
${Weekly_Report_Close}        com.coveiot.android.boat.qa:id/ivClose
...
${Profile_pic}             com.coveiot.android.boat.qa:id/imgVProfilePic
${Steps_count}             com.coveiot.android.boat.qa:id/tvStepsCount
${Goal_details}            com.coveiot.android.boat.qa:id/tvGoalDetail
...
${Top_Features_boat.qa_Coins}      //android.widget.TextView[@text="boat.qa Coins"]
...
${Fitness_overview_headder}         com.coveiot.android.boat.qa:id/tvFitnessOverviewHeader
${Sleep_Value}             com.coveiot.android.boat.qa:id/tvValue3
...
${Fitness_Vitals_Option}        com.coveiot.android.boat.qa:id/tvFitnessVitals
...
${boat.qa_Exclusive_headder}             //android.widget.TextView[@text="boat.qa exclusive"]
${My_Buddies_headder}                //android.widget.TextView[@text="My buddies"]
${700_Activity_Card}              //android.widget.TextView[@text="View Activities"]
${Do_more_headder}              com.coveiot.android.boat.qa:id/tvDoMoreWithYourWatch
...
${Cult_fit_headder}                     com.coveiot.android.boat.qa:id/tvCultFitHeader
${Cult_Videos}                       //android.widget.TextView[@text="10+ Videos"]
${Challenges_Headder}                 //android.widget.TextView[@text="Challenges"]
${Best_Offers_headder}                com.coveiot.android.boat.qa:id/tvBestOffers
...
${Watch_Status_Text}          com.coveiot.android.boat.qa:id/watch_status
${Watch_Disconnect_Text}       com.coveiot.android.boat.qa:id/disconnect
...
${AAD_Pop_OK_button}        com.coveiot.android.boat.qa:id/btn_ok
...
${Save_button}       com.coveiot.android.boat.qa:id/btn_ok
${Ok_button}         com.coveiot.android.boat.qa:id/positive_btn
...
${TouchELX_Add_Reminder_button}         com.coveiot.android.boat.qa:id/btnAddEvent
${TouchELX_Enter_Reminder_Name}        com.coveiot.android.boat.qa:id/etEventName
${TouchELX_Enter_Reminder_DateTime}        com.coveiot.android.boat.qa:id/dateTimeView
${TouchELX_Set_Reminder_Button}          com.coveiot.android.boat.qa:id/btnSetReminder
${TouchELX_Delete_Reminder_Button}           com.coveiot.android.boat.qa:id/deleteImgV
${Save_Event_Reminder_Button}               com.coveiot.android.boat.qa:id/btnSave

${TouchELX_Enable/Disable_Camera}         com.coveiot.android.boat.qa:id/switch_camera
...
${TouchELX_View-Goals_Option}          com.coveiot.android.boat.qa:id/tv_view_goals
...
${TouchELX_Steps_Goal_Save_Button}             com.coveiot.android.boat.qa:id/btn_save
${TouchELX_Max_Alarm_Toast}         //android.widget.Toast[@text="Maximum alarms allowed on watch is 10"]


#Auto HR
${Enable/Disable_autoHR}        com.coveiot.android.boat.qa:id/switch_auto_hr
${HR_Save_button}             com.coveiot.android.boat.qa:id/btnSave

#Auto Stress
${Enable/Disbale_stress}         com.coveiot.android.boat.qa:id/switch_reminder
${Stress_Save_button}             com.coveiot.android.boat.qa:id/btnSave
${Boat_Logo}             com.coveiot.android.boat.qa:id/imgVLogo

#NBR

${Enable/Disable_Respiratory}      com.coveiot.android.boat.qa:id/switch_respiratory_rate
${NBR_Save}                         com.coveiot.android.boat.qa:id/btnSave

 ##Alarm

${Add_Alarm_Button}       com.coveiot.android.boat.qa:id/add_alarm_btn
${Alarm_Time_OK}           //android.widget.Button[@text="OK"]
${Save_Alarm_Button}       com.coveiot.android.boat.qa:id/save_alarm_btn
${Max_Alarm_Toast}         //android.widget.Toast[@text="Maximum alarms allowed on watch is 5"]



#Sedentary
${Enable/Disable_sedentary}           com.coveiot.android.boat.qa:id/switch_reminder
${Sedentary_Save}                     com.coveiot.android.boat.qa:id/btnSave

#Nudges

${Enable/Disbale_Nudge}        com.coveiot.android.boat.qa:id/switch_nudges
${Nudge_Save}                 	com.coveiot.android.boat.qa:id/btnSave

#Bleetooth Calling
${Back_arrow}              com.coveiot.android.boat.qa:id/toolbar_back_arrow

 #Find My watch

${Find_watch_text}        com.coveiot.android.boat.qa:id/tv_searching_for_watch

#weather
${Enable/Disbale_weather}       com.coveiot.android.boat.qa:id/switch_weather
...
${Enbale/Disbale_Call_Notification}        com.coveiot.android.boat.qa:id/call_notification_value
...
${Enable/Disable_SMS_notification}            com.coveiot.android.boat.qa:id/sms_notification_value

#SensAI
${SensAI_Feature}                 //android.widget.TextView[@text="SensAI"]
${SnseAI_Skip}              com.coveiot.android.boat.qa:id/tvSkip
${Proceed_to_SesnAI_Button}        com.coveiot.android.boat.qa:id/btnNext
...
${Batting_text}                  com.coveiot.android.boat.qa:id/tvBatting
${Bowling_text}              com.coveiot.android.boat.qa:id/tvBowling


#Watch Control
${Watch_control_feature}       //android.widget.TextView[@text="Watch control"]
${DND_feature}    com.coveiot.android.boat.qa:id/cl_donot_disturb

${Enable/Disable_DND}     com.coveiot.android.boat.qa:id/dnd_switch
${Quick_Reply_feature}      com.coveiot.android.boat.qa:id/cl_quick_reply
${Enable/Disable_QuickReply}      com.coveiot.android.boat.qa:id/quick_reply_switch
${Quick_reply_Discard_Save}        com.coveiot.android.boat.qa:id/negative_btn
${Done_buttton}           com.coveiot.android.boat.qa:id/tvDone
...
${Lift_view_option}            com.coveiot.android.boat.qa:id/lift_wrist_switch
${Lift_View_Arrow}           //android.widget.TextView[@text="Wakeup gesture"]
${Enable/Disable_Lift_View}      com.coveiot.android.boat.qa:id/switch_reminder
...
${Distnace_unit_text}      com.coveiot.android.boat.qa:id/selected_distance_unit_text
${OK_popup}          com.coveiot.android.boat.qa:id/ok_popup
${Select_HR}         com.coveiot.android.boat.qa:id/selected_hour_text
${About_watch}         //android.widget.TextView[@text="About watch"]
${Firmware_Version}      com.coveiot.android.boat.qa:id/tv_firmware_version
${Watch_Name}         com.coveiot.android.boat.qa:id/tv_model_number
${App_Version}           com.coveiot.android.boat.qa:id/tv_app_version
...
${ShareIcon_Fitness}             com.coveiot.android.boat.qa:id/iv_share
${Goal_Insight_headder}          com.coveiot.android.boat.qa:id/tv_goals_insights

   #Days
${Days_tab}          com.coveiot.android.boat.qa:id/tvDay
${Share_Icon}        com.coveiot.android.boat.qa:id/ibShareVitals
${Cove_logo}         com.coveiot.android.boat.qa:id/iv_app_logo
${Powerd_by_covetext}     com.coveiot.android.boat.qa:id/iv_powered_cove
${desclimer_text}          com.coveiot.android.boat.qa:id/disclaimer_info
${Share_button}           com.coveiot.android.boat.qa:id/share_button
${Close_ShareCard}           com.coveiot.android.boat.qa:id/share_close_image

   #Week
${Week_text}             com.coveiot.android.boat.qa:id/tvWeek

   #Month
${Month_text}             com.coveiot.android.boat.qa:id/tvMonth
...
${watch_name_text}           com.coveiot.android.boat.qa:id/topHeaderTv         Cosmos Pro
${Cosmos_watchface}       com.coveiot.android.boat.qa:id/wfCosmosPro
${BT_status_text}         com.coveiot.android.boat.qa:id/btStatusTv
${Battery_status_text}     com.coveiot.android.boat.qa:id/batteryStatusTv
${Sync_status_text}         com.coveiot.android.boat.qa:id/syncStatusTv
${BT_call_status_text}    com.coveiot.android.boat.qa:id/btCallStatusTv
${Watch_Settings_option}   com.coveiot.android.boat.qa:id/watchSettingsTv
${watch_face_option}      com.coveiot.android.boat.qa:id/tvChangeYourWatchFace
...
${find_my_watch_text}           com.coveiot.android.boat.qa:id/findMyWatchTv
${find_my_watch_text1}           //android.widget.TextView[@text="Find my watch"]
${BT_calling_text_option}      com.coveiot.android.boat.qa:id/bluetoothCallingTv
...
#Profile
${User_Name}             com.coveiot.android.boat.qa:id/tv_name
${Contact_Number}        //android.widget.TextView[@text="+917829190451"]
${View_Profile_Option}    com.coveiot.android.boat.qa:id/tv_view_profile
${My_Goals_Headder}               com.coveiot.android.boat.qa:id/tv_my_goals
...
${My_Achievement_headder}     com.coveiot.android.boat.qa:id/tv_my_achievements
${Badges_Card}        //android.widget.TextView[@text="Badges"]
${Rank_Card}         //android.widget.TextView[@text="Rank"]
${boat.qa_Coins_Card}        //android.widget.TextView[@text="boat.qaCoins"]
${Fitness_Buddies_headder}     com.coveiot.android.boat.qa:id/tv_fitness_buddiess
...
${More_headder}          	com.coveiot.android.boat.qa:id/tv_more
...
${Log_out}                com.coveiot.android.boat.qa:id/tv_logout
${Delete_MY_Account}      com.coveiot.android.boat.qa:id/tv_delete_myaccount
${App_version_text}       com.coveiot.android.boat.qa:id/tv_app_version
#My Details
${Profile_Competion_Text}      //android.widget.TextView[@text="Profile completion"]
${Complete_Profile_Option}       com.coveiot.android.boat.qa:id/tvCompleteProfile
${Edit_Name}           com.coveiot.android.boat.qa:id/updateNameEditText
${Edit_Email}         com.coveiot.android.boat.qa:id/updateEmailEditText
${Change_Contact}      com.coveiot.android.boat.qa:id/tvContactChange
${Edit_Gender}        com.coveiot.android.boat.qa:id/updateGenderEditText
${Male_Gender}        com.coveiot.android.boat.qa:id/rbMale
${Female_Gender}      com.coveiot.android.boat.qa:id/rbFemale
${Close_Gender_Popup}       //android.widget.TextView[@text="Select gender"]
${Edit_DOB}                com.coveiot.android.boat.qa:id/updateDateOfBirthEditText
${Edit_Height}             com.coveiot.android.boat.qa:id/tvHeightUnit
${Edit_Weight}             com.coveiot.android.boat.qa:id/tvWeightUnit
${BMI_headder}                     com.coveiot.android.boat.qa:id/tvBmi
${Walk_Stride_Length}        com.coveiot.android.boat.qa:id/tvMyStride
${Run_Stride_Length}         com.coveiot.android.boat.qa:id/tvMyRunStride
${Update_Profile_Button}      com.coveiot.android.boat.qa:id/btn_update_profile
${Profile_Completion_Greeting}         com.coveiot.android.boat.qa:id/congratulations
${Greeting_Close_Option}                 com.coveiot.android.boat.qa:id/btnClose
${My_Achievement_Location}       //android.widget.Button[@text="Use my location"]
${My_Achievement_Card}          com.coveiot.android.boat.qa:id/tv_achievements_text
${Close_Option}                  //android.widget.TextView[@text="Close"]

#Fitness Plan
${Build_Fitness_Plan_Card}                //android.widget.TextView[@text="Build a fitness plan"]
${Fitness_Journey_Headder_Text}           com.coveiot.android.boat.qa:id/tv_fitness_journey
${Ongoing_Fitness_Status_Text}             com.coveiot.android.boat.qa:id/tvWeekPlanStatus
${Subscribe_Plan_Text}                       //android.widget.TextView[@text="Subscribed. Your plan starts tomorrow. Good Luck!"]
${Fitness_Plans_Text}                      com.coveiot.android.boat.qa:id/tv_fitness_plan
${Week_Text}                           com.coveiot.android.boat.qa:id/tvPlanTitle
${Week1_Title_Text}                       //android.widget.TextView[@text="Week 1"]
${Start_Plan_Button}                    com.coveiot.android.boat.qa:id/btn_build_plan
...
${Plan_Duration_text}                com.coveiot.android.boat.qa:id/tv_plan_duration
${Todays_Goal_Text}                  //android.widget.TextView[@text="Today’s Goal"]
${End_Plan_option}                  //android.widget.TextView[@text="End Plan"]
${Unsubscribe_Fitness_Plan_Button}        com.coveiot.android.boat.qa:id/tvUnsubscribePlan
${Unsbcirbe_Fitness_Plan_Confirmation_Button}          com.coveiot.android.boat.qa:id/positive_btn
