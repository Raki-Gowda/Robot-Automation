...
Login_and_Pair_Device
    ...
    Sleep       10
ULC_Wave_Smart_Call_Dashboard_Page
    CA_Pro_Landing_Page
ULC_Wave_Smart_Call_Settings_Page
    Goto_Settings_Page
    Sleep      4
ULC_Wave_Smart_Call_Features_Verification
...
ULC_Wave_Smart_Call_Fitness_Vitals_Page
...
#ULC_Wave_Smart_Call_Fitness_Plan
#    Fitness_Page_Fitness
#    Fitness_Plan_Page
ULC_Wave_Smart_My_Watch_Page
    ULC_Wave_Beat_Call_My_Watch_Page
ULC_Wave_Smart_Call_Profile_Page
    CA_Pro_Profile_Page
ULC_Wave_Smart_Call_Home_Page
